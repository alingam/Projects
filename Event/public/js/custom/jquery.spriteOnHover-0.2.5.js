...
$.fn.spriteOnHover = function(args){
                    ...
                    var  node = (typeof args.node == "object") ? args.node : $($(this).find(args.node));
                    var looper_in;
					var looper_out;
                    var $this =  node;
									...
									if(!executou){
										...
										looper_in = setInterval(function(){
												...
												if(counter == (number_of_frames)){
														...
														if(sprite_orientation == 'horizontal'){
                                                            $this.css("background-position","-"+margin_size+"px 0px");
														}else{
                                                            $this.css("background-position","0px -"+margin_size+"px");
														}
